...
transition={{delay:0.2,duration:0.8}}
  ...
  <img src={assets.star_icon} alt=""/>
    ...
    <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>
        Turn text to <span className='text-blue-600'initial={{ opacity: 0 }}
animate={{ opacity: 1 }}
...
transition={{ delay: 0.4, duration: 2 }}>
        Unleah your creativity with AI. Turn your imagination into visual art in seconds-just type,and watch the magic happen.
    </motion.p>
...
animate={{ opacity: 1 }}
transition={{ delay: 1.2, duration: 0.8 }} className='mt-2 text-neutral-600'>
